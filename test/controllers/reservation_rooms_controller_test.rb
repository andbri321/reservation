...
class ReservationRoomsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create reservation_room" do
    assert_difference("ReservationRoom.count") do
      post reservation_rooms_url, params: { reservation_room: { date: @reservation_room.date, room_id: @reservation_room.room_id, user_id: @reservation_room.user_id } }
    end
  ...
  test "should update reservation_room" do
    patch reservation_room_url(@reservation_room), params: { reservation_room: { date: @reservation_room.date, room_id: @reservation_room.room_id, user_id: @reservation_room.user_id } }
