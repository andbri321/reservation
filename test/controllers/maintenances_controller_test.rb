...
class MaintenancesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create maintenance" do
    assert_difference("Maintenance.count") do
      post maintenances_url, params: { maintenance: { description: @maintenance.description, room_id: @maintenance.room_id, time: @maintenance.time, user_id: @maintenance.user_id } }
    end
  ...
  test "should update maintenance" do
    patch maintenance_url(@maintenance), params: { maintenance: { description: @maintenance.description, room_id: @maintenance.room_id, time: @maintenance.time, user_id: @maintenance.user_id } }
